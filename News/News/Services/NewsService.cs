...
namespace News.Services
{
    public class NewsService
    {
        ...
        public string HeadLines => "https://newsapi.org/v2/top-headlines?" + "country=us&" + $"apiKey={Settings.NewsApiKey}";

        public string Local => "https://newsapi.org/v2/everything?" + "q=local&" + $"apiKey={Settings.NewsApiKey}";

        public string Global => "https://newsapi.org/v2/everything?" + "q=global&" + $"apiKey={Settings.NewsApiKey}";
    }
}
