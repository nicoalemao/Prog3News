...
namespace News.ViewModels
{
    public class HeadLinesViewModel : ViewModel
    {
        ...
        public ICommand ItemSelected => new Command( async(selectedItem) => { var selectedArticle = selectedItem as Article; var url = HttpUtility.UrlEncode(selectedArticle.Url); } );
    }
}
